...
class UsuarioAdapter (private val profList:ArrayList<UsuarioModel>,private val listener:OnItemClickListener) : RecyclerView.Adapter<UsuarioAdapter.ProfViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProfViewHolder {

        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.list_view_usuario,parent,false)
